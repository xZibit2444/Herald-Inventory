...
const defaultInventoryData = [
    ...
    { id: 4, name: 'Desk Chairs', category: 'Furniture', quantity: 2, location: 'Office Floor', status: 'Checked Out' },
    { id: 5, name: 'Staplers', category: 'Stationery', quantity: 12, location: 'Shelf 2', status: 'In Stock' },
    { id: 6, name: 'Laptops (Dell)', category: 'Electronics', quantity: 1, location: 'IT Room', status: 'Checked Out' },
